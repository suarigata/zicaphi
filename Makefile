...
CC=icc
# Compiler flags
#CFLAGS=-O3 -fno-inline -std=gnu99 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -fopenmp
CFLAGS=-O3 -ipo -std=gnu99 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -fopenmp
